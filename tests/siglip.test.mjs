...
describe("siglip probe", () => {
  ...
  it("soft-ORs with Community Forensics counted twice", () => {
    assert.ok(Math.abs(blendVisual(0.2, 0.9) - (1 - 0.8 * 0.1 * 0.1)) < 1e-9);
    assert.ok(blendVisual(0.4, 0.8) > 0.4 + 0.8 - 0.4 * 0.8);
  });
