...
describe("fuse", () => {
  ...
  it("lifts a low-clip mid-range visual without inventing a verdict from highlights alone", () => {
    const lifted = fuseScores({
      visual: 0.56,
      provenance: { ai: false, camera: false },
      graphic: { isGraphic: false, lowClip: true },
    });
    assert.ok(lifted.fusedBeforeCalibration > 0.56);
    assert.ok(lifted.reasons.includes("low-clip"));
